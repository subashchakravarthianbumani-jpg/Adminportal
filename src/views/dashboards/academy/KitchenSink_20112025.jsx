...
const KitchenSink = () => {
      ...
      const sortingPayload = sortingState.id
        ...
        const requestData = {
          skip,
            ...
            columnSearch: [],
            where: {"RegistrationType": ["EXHIBITORS"], "IsActive": [1]}
        };
 ...
 const exportToPdf = () => {
     ...
     doc.text('Exhibitors Details', 10, 10);
     ...
     doc.save('Exhibitors Details.pdf');
 };
   ...
   const exportToExcel = () => {
     ...
     // Trigger download
     XLSX.writeFile(workbook, 'Exhibitors Details.xlsx');
   };
