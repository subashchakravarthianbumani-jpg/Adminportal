    ...
    try {
      ...
      const sortingPayload = sortingState.id
        ...
        const requestData = {
          skip,
            ...
            columnSearch: [],
            where: {"RegistrationType": ["EXHIBITORS"]},
          IsStallApproved: 'NULL'
        };
      ...
      const [
        ...
        { data: categoryData }
            ...
            console.log("nandhu..check.",registrationData.data);
  ...
  const handleApprove = async (rowData) => {
    ...
    if (confirmApprove.isConfirmed) {
      ...
      try {
        ...
        Swal.fire('Success', 'The registration has been approved!', 'success');
      } catch (error) {
