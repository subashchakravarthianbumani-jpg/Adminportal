...
const data1 = [
  { title: 'Exhibitor', value: 35, colorClass: 'text-primary' },
  { title: 'Visitors', value: 20, colorClass: 'text-info' },
]

const data2 = [
  { title: 'Seminar Attendee', value: 10, colorClass: 'text-success' },
  { title: 'Other', value: 9, colorClass: 'secondary-main' }
]

const labels = [ 'Exhibitor', 'Visitors', 'Seminar Attendee', 'Other']
