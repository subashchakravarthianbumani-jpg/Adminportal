...
const VerticalMenu = ({ dictionary, scrollMenu }) => {
  ...
  const ScrollWrapper = isBreakpointReached ? 'div' : Scrollbar
    ...
    >
      ...
      >
        <MenuItem href={`/${locale}/dashboards/dashboard`} icon={<i className='ri-home-smile-line' />}>
          ...
          <MenuItem href={`/${locale}/dashboards/registration`} icon={<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path fill="currentColor" d="M4 22a8 8 0 1 1 16 0h-2a6 6 0 0 0-12 0zm8-9c-3.315 0-6-2.685-6-6s2.685-6 6-6s6 2.685 6 6s-2.685 6-6 6m0-2c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4"/></svg>}>
            {dictionary['navigation'].registration}
          </MenuItem>
          <MenuItem href={`/${locale}/dashboards/stallallocation`} icon={<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path fill="currentColor" d="M3 10a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1zm8 10a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1h-8a1 1 0 0 0-1 1zm2-5h6v4h-6zM3 20a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1zm2-1v-4h2v4zM5 9V5h6v4zm15 2a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1zm-1-2h-2V5h2z"/></svg>}>
            {dictionary['navigation'].stallallocation}
          </MenuItem>

          <MenuItem href={`/${locale}/dashboards/dailyreport`} icon={<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" ><path fill="currentColor" d="M5 3V19H21V21H3V3H5ZM20.2929 6.29289L21.7071 7.70711L16 13.4142L13 10.415L8.70711 14.7071L7.29289 13.2929L13 7.58579L16 10.585L20.2929 6.29289Z"></path></svg>}>
            {dictionary['navigation'].dailyreport}
          </MenuItem>

          <SubMenu
          label={dictionary['navigation'].report}
          icon={<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path fill="currentColor" d="M3 12h4v9H3zm14-4h4v13h-4zm-7-6h4v19h-4z"/></svg>}
        >
        <MenuItem href={`/${locale}/dashboards/exhibitor`}>{dictionary['navigation'].exhibitor}</MenuItem>
          <MenuItem href={`/${locale}/dashboards/seminarattendee`}>{dictionary['navigation'].seminarattendee}</MenuItem>
          <MenuItem href={`/${locale}/dashboards/visitor`}>{dictionary['navigation'].visitor}</MenuItem>
          <MenuItem href={`/${locale}/dashboards/others`}>{dictionary['navigation'].others}</MenuItem>
        </SubMenu>


          <MenuSection label={dictionary['navigation'].settingsdashboard}>

          <MenuItem href={`/${locale}/dashboards/configuration`} icon={<i className='ri-global-line' />}>
            {dictionary['navigation'].configuration}
          </MenuItem>
          <SubMenu label={dictionary['navigation'].settings} icon={<i className='ri-settings-2-line' />}>
          <MenuItem href={`/${locale}/dashboards/formSettings`} >{dictionary['navigation'].FormSettings}</MenuItem>
          <MenuItem href={`/${locale}/dashboards/adminSettings`} >{dictionary['navigation'].AdminSettings}</MenuItem>
          <MenuItem href={`/${locale}/dashboards/stallSettings`} >{dictionary['navigation'].StallSettings}</MenuItem>
          </SubMenu>
          <MenuItem href={`/${locale}/dashboards/logs`} icon={<i className='ri-history-fill' />} >{dictionary['navigation'].logs}</MenuItem>
          </MenuSection>
